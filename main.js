...
class StartScene extends Phaser.Scene {
  ...
  createHomeMenuPortrait() {
    ...
    this.createMenuButton(this.homeContainer, GAME_WIDTH / 2, 576, 320, 76, "اختر شخصيتك", {
      fillColor: 0x090914,
      strokeColor: 0xf5f1ee,
      labelColor: "#f5f1ee",
      icon: "◀",
...
class DoraBossScene extends Phaser.Scene {
  ...
  create(data = {}) {
    ...
    this.physics.add.collider(this.volleyBolts, this.floor, (bolt) => {
      bolt.destroy();
    });
    this.physics.add.overlap(
      this.player,
  ...
  firePlayerBullet() {
    ...
    bullet.setVelocityX(direction * 720);
    bullet.setDepth(15);
    this.tweens.add({
      targets: bullet,
      alpha: 0.7,
...
class ResultScene extends Phaser.Scene {
  ...
  create(data = {}) {
    ...
    const hero = this.add
      .sprite(GAME_WIDTH / 2, 250, this.characterProfile.idleKey)
      .setScale(2.2);
    ...
    this.add
      .text(GAME_WIDTH / 2, 420, resultTitle ?? (didWin ? "فزت" : "انتهت اللعبة"), {
        fontFamily: "Changa",
        fontSize: "82px",
        fontStyle: "bold",
    ...
    createActionCard(
      ...
      628,
      "إعادة",
      useMobileUi ? "العب من جديد" : "Replay",
      0x0a1623,
      0x59d1ff,
      restartGame
    );
    createActionCard(
      ...
      628,
      "القائمة",
      useMobileUi ? "العودة للبداية" : "Home Menu",
      0x180814,
      0xff6cb8,
      goHomeMenu
    );
